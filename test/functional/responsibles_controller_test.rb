...
class ResponsiblesControllerTest < ActionController::TestCase
  ...
  test "should create responsible" do
    assert_difference('Responsible.count') do
      post :create, responsible: { extension: @responsible.extension, genre: @responsible.genre, identification: @responsible.identification, name: @responsible.name, phone: @responsible.phone, surname: @responsible.surname }
    end
  ...
  test "should update responsible" do
    put :update, id: @responsible, responsible: { extension: @responsible.extension, genre: @responsible.genre, identification: @responsible.identification, name: @responsible.name, phone: @responsible.phone, surname: @responsible.surname }
    assert_redirected_to responsible_path(assigns(:responsible))
  end
