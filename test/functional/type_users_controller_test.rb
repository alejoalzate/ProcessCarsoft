...
class TypeUsersControllerTest < ActionController::TestCase
  ...
  test "should create type_user" do
    assert_difference('TypeUser.count') do
      post :create, type_user: { acronym: @type_user.acronym, description: @type_user.description, name: @type_user.name }
    end
  ...
  test "should update type_user" do
    put :update, id: @type_user, type_user: { acronym: @type_user.acronym, description: @type_user.description, name: @type_user.name }
    assert_redirected_to type_user_path(assigns(:type_user))
  end
